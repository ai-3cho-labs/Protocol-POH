...
export interface RewardHistoryProps {
  ...
  history: RewardHistoryItem[] | null;
  /** Is data loading */
  isLoading?: boolean;
  /** Max items to show */
  limit?: number;
...
/**
 * RewardHistory - User's mining reward receipts
 */
export function RewardHistory({
  ...
  if (isLoading) {
    return <RewardHistorySkeleton limit={limit} className={className} />;
  }
...
function RewardHistorySkeleton({
  ...
  return (
    <TerminalCard title="REWARD HISTORY" className={className}>
      <div className="space-y-2">
