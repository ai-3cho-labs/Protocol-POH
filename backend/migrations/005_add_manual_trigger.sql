...
-- Drop and recreate the check constraint to include 'manual'
ALTER TABLE distributions DROP CONSTRAINT IF EXISTS valid_trigger;
ALTER TABLE distributions ADD CONSTRAINT valid_trigger CHECK (trigger_type IN ('threshold', 'time', 'manual'));
